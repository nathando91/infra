...
bash Copy code curl -Ls https://github.com/nathando91/install-git-hook/blob/main/install-script.sh | sh This command downloads and executes the installation script, which automatically places the pre-commit hook into your .git/hooks directory.
